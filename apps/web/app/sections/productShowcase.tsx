...
export const ProductShowcase = () => {
    return <section className="bg-gradient-to-b from-[#FFFFFF] to-[#D2DCFF] py-22">
        <div className="container">
            ...
            <div className="text-sm inline-flex border border-[#222]/10px-3 py-1 rounded-md tracking-tight">Boost Customer Engagement with AI-Powered Support Agent</div>
            </div>
            ...
            <Image src="/Dashview.png" alt="Logo" width={1000} height={1000}/>
            </div>
